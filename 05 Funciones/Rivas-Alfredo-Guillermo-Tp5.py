...
""" lista_uno_cien = list(range(0,101,4))
print (lista_uno_cien) """
...
print(numeros)
"""
""" El programa crea una lista con 5 valores numericos. Luego elimina el valor numerico mas "grande". Por ultimo muestra la lista actualizada """

""" 6) Crear una lista con números del 10 al 30 (incluído), haciendo saltos de 5 en 5 y mostrar por pantalla los dos primeros. """

""" lista_diez_treinta = list(range(10,31,5))
print (lista_diez_treinta[:2]) """
